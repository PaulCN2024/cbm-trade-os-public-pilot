...
- Knowledge Base RLS Policy Pack Prepared is completed; first-stage authenticated-read-only RLS plan, SQL file, manual SQL guide, and verification checklist are ready, SQL safety scan passed, and Codex did not execute SQL or touch the database
...
1. Paul manual action - Review and execute `docs/ops/knowledge-base-rls-policy.sql` in Supabase Dashboard SQL Editor
2. CBM-CODEX-KNOWLEDGE-RLS-POST-VERIFY-001 - Verify Knowledge Base RLS after manual SQL execution
