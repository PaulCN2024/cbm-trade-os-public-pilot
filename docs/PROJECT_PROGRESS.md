...
- Current active area: Phase UI-3 / Business Card Capture Read-only Data Foundation
...
1. CBM-CODEX-SPRINT-BUSINESS-CARD-CAPTURE-DATA-READONLY-001 - Plan/prepare read-only data foundation for reviewed card capture records
