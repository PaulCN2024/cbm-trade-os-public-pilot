...
- Current active area: Phase UI-3 / AI Inquiry Intelligence read-only data foundation production verification
...
1. CBM-CODEX-RELEASE-INQUIRY-INTELLIGENCE-001 - Deploy and smoke verify the inquiry intelligence read-only foundation
2. CBM-CODEX-SPRINT-SUPPLIER-INTELLIGENCE-UI-001 - Add or plan a static/read-only Supplier Intelligence preview
...
4. CBM-CODEX-SPRINT-INQUIRY-INTELLIGENCE-QUOTE-READINESS-READONLY-001 - Implement or plan read-only quote-readiness projection without quotation creation
